...
window.c1.textContent=text[0];
window.p2.style.display="none";
window.c2.textContent=text[1];
window.p3.style.display="none";
window.c3.textContent=text[2];
window.p4.style.display="none";
window.c4.textContent=text[3];
window.p5.style.display="none";
window.c5.textContent=text[4];
window.p6.style.display="none";
window.c6.textContent=text[5];
